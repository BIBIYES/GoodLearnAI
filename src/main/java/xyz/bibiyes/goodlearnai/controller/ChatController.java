...
public class ChatController {
    ...
    public SseEmitter sseEmitter(String prompt) {
        ...
        ChatGPTStream chatGPTStream = ChatGPTStream.builder().timeout(600).apiKey("fastgpt-xCyK8iQF4gSmmiZeeAcHarJC58XikqPQizjOilK3k5eumw9PilcXISSc")//              .proxy(proxy)
                // 替换为你的实际 API 主机地址
                .apiHost("http://10.181.146.107/api/").build().init();
